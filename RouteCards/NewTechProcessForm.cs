...
namespace RouteCards
{
    public partial class NewTechProcessForm : Form
    {
        ...
        TechProcessRepo techProcessRepo = new TechProcessRepo();
        ...
        void GetItems()
        {
            var items = repo.GetAll(codeFilterPlaceholderTextBox.Value, nameFilterPlaceholderTextBox.Value);
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            techProcessRepo.Add(newTechProcess);
