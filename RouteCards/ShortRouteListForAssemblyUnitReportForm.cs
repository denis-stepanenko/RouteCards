...
{
    public partial class ShortRouteListForAssemblyUnitReportForm : Form
    {
        ...
        public ShortRouteListForAssemblyUnitReportForm(int cardId)
        {
            InitializeComponent();
            _cardId = cardId;
        ...
        void GetItems()
        {
            ...
            reportViewer.LocalReport.ReportEmbeddedResource = "RouteCards.Reports.ShortRouteListForAssemblyUnitReportForm.rdlc";
            ...
            reportViewer.LocalReport.DataSources.Add(new ReportDataSource("CardOperations", operations));
