...
@"insert into RCCards
(Number, ProductCode, ProductName, ProductCount, OwnerProductName, Stage, Department, Route, GroupName, Direction, ClientOrder, FactoryNumber, PickingListNumber, MaterialCode, MaterialName, MaterialParameter, ESDProtectionRequired, [Order], Date)
values
(@Number, @ProductCode, @ProductName, @ProductCount, @OwnerProductName, @Stage, @Department, @Route, @GroupName, @Direction, @ClientOrder, @FactoryNumber, @PickingListNumber, @MaterialCode, @MaterialName, @MaterialParameter, @ESDProtectionRequired, @Order, @Date);
